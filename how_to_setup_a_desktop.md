...
26. Setup remote connection. See info [here](./how_to_setup_remote_access.md).
...
28. Restart the machine. After reboot the machine will now go into the graphical interface and boot into "text-mode". To enable the graphical interface back, type: `sudo systemctl start gdm3.service` (or `lightdm.service` on 16.04).
